      ...
      >
        ...
        <aside
          ...
          >
            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-primary-50 shadow-md shadow-primary-800">
                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        ...
                        <svg className="w-5 h-5 text-primary-800 transition duration-75 group-hover:text-primary-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
              ...
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-primary-800 transition duration-75 group-hover:text-primary-800"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 21"
                ...
                >
                    ...
                    <Link
                        ...
                        className="flex items-center w-full p-2 text-primary-800 transition duration-75 rounded-lg pl-11 group hover:bg-secondary-400"
                    >
                        Usuarios activos
                    </Link>
                    </li>
                    ...
                    <li>
                        <a href="#" className="flex items-center p-2 text-primary-800 rounded-lg hover:bg-secondary-400 group">
                        <svg className="flex-shrink-0 w-5 h-5 text-primary-800 transition duration-75 group-hover:text-primary-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                        ...
                        <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-secondary-400 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className="flex items-center p-2 text-primary-800 rounded-lg hover:bg-secondary-400 group">
